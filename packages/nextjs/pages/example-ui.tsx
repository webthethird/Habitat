      ...
      <div className="flex flex-col gap-y-6 lg:gap-y-8 py-8 lg:py-12 justify-center items-center">
        <div className="grid grid-cols-1 lg:grid-cols-4 px-6 lg:px-10 lg:gap-12 w-full max-w-10xl my-0 ">
          <div className="col-span-2 lg:col-span-3 flex flex-col gap-6">
            <div
              className={`flex flex-col justify-center items-center bg-[length:100%_100%] py-10 px-5 sm:px-0 lg:py-auto max-w-[100vw] `}
            >
              {baseSVG ? (
              ...
              <div className="flex flex-col w-full mx-5 sm:mx-8 2xl:mx-20">
                {baseId ? (
                  <div className="flex flex-col mt-6 px-7 py-8 bg-base-200 opacity-80 rounded-2xl shadow-lg border-2 border-primary">
                    ...
                    <span className="text-2xl sm:text-3xl text-green">
                      You have {greenPoints ? utils.formatEther(greenPoints.mul(100))?.toString() : "0"} points
                    </span>
